(function(window, document) {
    const data = [{
        ...
        },
        {
            ...
            title: "Valle de sombras",
            url: "https://visuales.uclv.cu/Peliculas/Extranjeras/2024/Valle%20de%20sombras%20(2024)/",
            age: 2024,
            sub: false,
            description: "Cordillera del Himalaya, año 1999. Quique, Clara y el pequeño Lucas disfrutan de sus primeras vacaciones juntos en el norte de la India. Una noche, durmiendo al raso durante una tormenta, sufren un brutal ataque por unos bandidos. Horas después, Quique es rescatado por un nativo y trasladado a una remota aldea aislada en las montañas.",
            duration: "2 h",
            director: "Salvador Calvo",
            producedBy: ["Javier Ugarte", "Jaime Ortiz de Artiñano"],
            tutorial: "https://www.youtube.com/watch?v=2fno-YnUM4I",
            classifications: ["Suspenso", "Aventura"]
        }, {
            id: "upgrade",
            name: "Ascenso",
            title: "upgrade",
            url: "https://visuales.uclv.cu/Peliculas/Extranjeras/2024/Upgraded%20(2024)%20/",
            age: 2024,
            sub: true,
            description: "Ana, aspirante a becaria de arte, es ascendida inesperadamente cuando su jefa la manda a un viaje de trabajo de último momento a Londres. Allá, conoce al apuesto y adinerado William y decide vivir su fantasía más tiempo del que debería.",
            duration: "1h 44m",
            director: "Carlson Young",
            producedBy: ["Mike Karz", "William Bindley", "Lena Roklin", "Piers Tempest"],
            tutorial: "https://www.youtube.com/watch?v=P3_dj7BnHp8",
            classifications: ["Comedia", "Romance"]
        }, {
            id: "unstoppable",
            name: "Imparable: La historia de Anthony Robles",
            title: "unstoppable",
            url: "https://visuales.uclv.cu/Peliculas/Extranjeras/2024/Unstoppable/",
            age: 2024,
            sub: true,
            description: "A pesar de haber nacido con una sola pierna, Anthony Robles desafía todas las expectativas al convertirse en campeón de lucha libre en la universidad y rivalizar con la primera escuela que le rechazó.",
            duration: "1h 56m",
            director: "William Goldenberg",
            producedBy: ["Ben Affleck", "Elaine Goldsmith-Thomas", "Anthony Robles", "David Crockett", "Andy Fraser", "Gary Lewis"],
            tutorial: "https://www.youtube.com/watch?v=KG9dSgLnugc",
            classifications: ["Deportes", "Drama"]
        }, {
            id: "Un_mal_dia_lo_tiene_cualquiera",
            name: "Un mal día lo tiene cualquiera",
            title: "Un mal día lo tiene cualquiera",
            url: "https://visuales.uclv.cu/Peliculas/Extranjeras/2024/Un%20mal%20dia%20lo%20tiene%20cualquiera%20(2024)/",
            age: 2024,
            sub: false,
            description: "Sonia es una mujer responsable, ordenada y con el sentido de la norma muy integrada. La noche antes de defender su tesis doctoral, su mejor amiga le pide que la acompañe a un concierto.",
            duration: "1h 18m",
            director: "Eva Hache",
            producedBy: ["Jelen Morales", "María Elena Morales García"],
            tutorial: "https://www.youtube.com/watch?v=XY5G74BnOHo",
            classifications: ["Comedia"]
        }, {
            id: "Un_Jour_Fille",
            name: "Un Jour Fille",
            title: "Un Jour Fille",
            url: "https://visuales.uclv.cu/Peliculas/Extranjeras/2024/Un%20jour%20fille%20(2024)/",
            age: 2024,
            sub: true,
            description: "Siglo XVIII. Ana tiene que 'cambiarse de ropa' debido a su atracción por las mujeres. Ya hombre, se casa y ama a su esposa, hasta que su pasado lo alcanza. La impactante historia de Ana Grandjean, nacida intersexual, y su juicio.",
            duration: "1h 33m",
            director: "Jean-Claude Monod",
            producedBy: [],
            tutorial: "https://www.cineserie.com/movies/5985331/video/5654588/",
            classifications: ["Drama"]
        }, {
            id: "Un_hipster_en_la_Espana_vacia",
            name: "Un hipster en la España vacía",
            title: "Un hipster en la España vacía",
            url: "https://visuales.uclv.cu/Peliculas/Extranjeras/2024/Un%20hipster%20en%20la%20Espana%20vacia%20(2024)/",
            age: 2024,
            sub: true,
            description: "Quique es enviado a un pueblo de España para dirigir su política de recuperación. Pronto descubre que enviarle allí es un plan de su novia y del líder de su partido para estar juntos. Ahora, solo tiene la ayuda de Lourdes, una camarera.",
            duration: "1h 37m",
            director: "Emilio Martínez-Lázaro",
            producedBy: [""],
            tutorial: "https://www.youtube.com/watch?v=ne2sd6If834",
            classifications: ["Comedia"]
        }, {
            id: "Unfrosted",
            name: "Unfrosted: The Pop-Tart Story",
            title: "Unfrosted",
            url: "https://visuales.uclv.cu/Peliculas/Extranjeras/2024/Unfrosted%20(2024)/",
            age: 2024,
            sub: true,
            description: "En 1963, Kellogg's y Post, rivales de los cereales, compiten para crear un pastelito que cambiará el desayuno para siempre.",
            duration: "1h 33m",
            director: "Jerry Seinfeld",
            producedBy: ["Jerry Seinfeld", "Spike Feresten", "Beau Bauman"],
            tutorial: "https://www.youtube.com/watch?v=2lqRPUhPfho",
            classifications: ["Comedia", "Drama"]
        }
    ]
